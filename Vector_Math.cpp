...
namespace vmath
{
    ...
    std::wostream& operator<<(std::wostream& os, vec2f const& v)
    {
        return os << L"[ X:" << v.x << L" Y:" << v.y << L" ]";
    }


    std::string& operator+(std::string& str, const vec2f& v)
    {
        return str.append("[ X:" + std::to_string(v.x) + " Y:" + std::to_string(v.y) + " ]");
    }


    std::wstring& operator+(std::wstring& str, const vec2f& v)
    {
        return str.append(L"[ X:" + std::to_wstring(v.x) + L" Y:" + std::to_wstring(v.y) + L" ]");
    }
    ...
    vec2f::operator std::wstring() const
    {
